...
module.exports = {
	...
	sequelize.sync() // { alter/force: true }
		...
		.then(() => {
			return Player.create({ guildID: '1032034043686035508', discordID: '762118143350669332', playerName: 'Tweezy', faction: 'Cerberon' });
		})
		.then((data1) => {
			return data1.createIura({ walletName: 'Tweezy', bankName: 'Tweezy', walletAmount: '100' });
		})
