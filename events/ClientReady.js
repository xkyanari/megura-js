...
module.exports = {
	...
	sequelize.sync({ force: true }) // { alter/force: true }
		...
		.then(() => {
			return Player.create({ guildID: '1032034043686035508', discordID: '119671611803697152', playerName: 'Kyanari', faction: 'Margaretha', totalAttack: '9999', totalDefense: '9999', totalHealth: '9999' });
		})
		.then((kyanari) => {
		...
		.then((dataJ) => {
			return dataJ.createIura({ walletName: 'Laboon', bankName: 'Laboon', walletAmount: '100' });
		})
